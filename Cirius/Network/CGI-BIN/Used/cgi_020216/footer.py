	...
	<div class='container'>     +\
		<div class='footer-main'>     +\
			<div class='footer-address'>     +\
				<svg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' version='1.1' x='0px' y='0px' width='133.872px' height='53.155px' viewBox='7.052 11.029 133.872 53.155' enable-background='new 7.052 11.029 133.872 53.155' xml:space='preserve'>    +\
                <style>.style0{fill:	#FFFFFF;}     +\
                </style>     +\
                <g><g><polygon points='11.837,18.02 11.902,18.02 18.59,35.932 25.337,35.932 25.337,11.434 20.555,11.434 20.555,28.4 20.487,28.4 13.975,11.434 7.052,11.434 7.052,35.932 11.837,35.932' class='style0'/>    +\
                ...
                <address>    +\
					Raleigh, NC 27695<br />    +\
					<span class='phone-number'>919.515.2011</span>    +\
				</address>    +\
            </div>    +\
			<div class='footer-links'>    +\
				<div class='row'>    +\
					<ul class='ncstate-padded-list'>    +\
						<li><a href='/about'>About NC State News</a></li>    +\
					</ul>    +\
					<ul class='ncstate-padded-list'>    +\
						<li><a href='http://web.ncsu.edu/annual-report/2014-2015/'>Chancellor's Annual Report</a></li>    +\
						<li><a href='http://policies.ncsu.edu/'>University Policies</a></li>    +\
		...
		<div class='footer-sub'>    +\
			<ul class='social-channels list-unstyled' aria-label='NC State Social Media channels'>    +\
				<li><a href='https://www.facebook.com/ncstate'><span class='glyphicon glyphicon-fb' data-alt='facebook'></span></a></li>    +\
				<li><a href='https://www.youtube.com/ncstate'><span class='glyphicon glyphicon-youtube' data-alt='youtube'></span></a></li>    +\
				<li><a href='http://www.twitter.com/ncstate/'><span class='glyphicon glyphicon-twitter' data-alt='twitter'></span></a></li>    +\
				<li><a href='http://instagram.com/ncstate'><span class='glyphicon glyphicon-instagram' data-alt='instagram'></span></a></li>    +\
				<li><a href='http://www.flickr.com/photos/ncstate'><span class='glyphicon glyphicon-flickr' data-alt='flickr'></span></a></li>    +\
				<li><a href='http://pinterest.com/ncstate/'><span class='glyphicon glyphicon-pintrest' data-alt='pinterest'></span></a></li>    +\
				<li><a href='https://plus.google.com/b/103088095123196361068/103088095123196361068/'><span class='glyphicon glyphicon-gplus' data-alt='google plus'></span></a></li>    +\
				<li><a href='http://news.ncsu.edu/feed/rss'><span class='glyphicon glyphicon-rss' data-alt='RSS'></span></a></li>    +\
			</ul>    +\
			<div class='copyrigh'>    +\
...
<script src='https://cdn.ncsu.edu/brand-assets/bootstrap/js/bootstrap.min.j'></script>    +\
<!-- Photo Gallery -->    +\
<script type='text/javascript' src='https://news.ncsu.edu/wp-content/themes/ncstate-news/js/fancybox/jquery.fancybox.pack.js?v=2.0.6'></script>    +\
<script type='text/javascript' src='https://news.ncsu.edu/wp-content/themes/ncstate-news/js/fancybox/jquery.fancybox-buttons.js?v=1.0.2'></script>    +\
<script type='text/javascript' src='https://news.ncsu.edu/wp-content/themes/ncstate-news/js/fancybox/jquery.fancybox-media.js?v=1.0.0'></script>    +\
<!-- Main js -->    +\
<script src='https://news.ncsu.edu/wp-content/themes/ncstate-news/js/main.js'></script>    +\
<!-- Google Analytics -->    +\
<script>    +\
  ...
  ga('create', 'UA-2824154-1', 'auto'); // Default News & Core property.    +\
  ga('create', 'UA-2824154-5', 'auto', {'name': 'global'});  // NC State Global.    +\
  ga('send', 'pageview');    +\
  ga('global.send', 'pageview'); // Send page view for NC State Global Property.    +\
</script>    +\
<script type='text/javascript' src='https://news.ncsu.edu/wp-content/plugins/akismet/_inc/form.js?ver=3.1.3'></script>    +\
</body>    +\
</html>    "
